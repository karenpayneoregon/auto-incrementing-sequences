...
public partial class Context : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=NextValueDatabase;Integrated Security=True;Encrypt=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<CustomerSequence>(entity =>
        {
            ...
            entity.HasOne(d => d.CustomerIdentifierNavigation).WithMany(p => p.CustomerSequence)
